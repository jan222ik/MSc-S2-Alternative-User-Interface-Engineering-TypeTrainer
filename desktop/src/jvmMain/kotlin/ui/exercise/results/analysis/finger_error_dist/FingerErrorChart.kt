...
package ui.exercise.results.analysis.finger_error_dist
...
import textgen.error.ChartErrorKey
import textgen.error.FingerErrorKey
import java.lang.Float.min

@Composable
fun FingerErrorChart(chartData: List<FingerErrorKey>, modifier: Modifier = Modifier) {
                ...
                IntProgression
                    ...
                    .map {
                        if (it < chartData.size) {
                            val charStr = when (
                                val c = chartData[it].finger.toString()
                            ) {
                                " " -> "\"$c\""
                                else -> c
                            }
